...
class FromTupleSpec extends FunSuite:
  ...
  test("Tuple to List"):
    ...
    assertCompiletimeError(
      ...
      """,
      26 -> """Tuple conversion error""",
      46 -> s"""Found: ("3" : java.lang.String)\nRequired: scala.Int""",
      39 -> s"""Found: (2.0 : scala.Double)\nRequired: scala.Int"""
    )
  ...
  test("Tuple to Map/ListMap"):
    ...
    assertCompiletimeError(
      ...
      """,
      26 -> """Tuple conversion error""",
      97 -> """Invalid `key -> value` pattern for Map""",
      81 -> s"""Found: ("3" : java.lang.String)\nRequired: scala.Double""",
      59 -> s"""Found: ("2" : java.lang.String)\nRequired: scala.Long"""
    )
  ...
  test("Tuple to new class instance"):
    ...
    assertCompiletimeError(
      ...
      """,
      26 -> """Tuple conversion error""",
      9 -> """Expected number of arguments for `class Foo` is 2, but found 3"""
    )
